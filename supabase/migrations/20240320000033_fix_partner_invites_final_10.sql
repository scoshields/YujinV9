...
ALTER TABLE workout_partners DROP CONSTRAINT IF EXISTS workout_partners_no_duplicates;
...
ALTER TABLE workout_partners ADD CONSTRAINT workout_partners_unique_pair 
